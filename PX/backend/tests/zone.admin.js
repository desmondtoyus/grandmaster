...
describe('Zone Admin testing', function() {
  const zoneAdmin = {
    email: 'zone@admin.com',
    password: password
  };

  const wrongZoneAdmin = {
    email: 'zone@admin.com',
    password: 'djfhdjfhdg'
  };

  const self_account_id = 12;
  const self_user_id = 8;
  ...
  describe('Update account', function() {
    ...
    it('Unauthorized to update account outside of the zone', function(done) {
      request({
        url: `${ROOT_URL}/account/update`,
        method: 'POST',
        json: {
  ...
  describe('Delete account', function() {
    ...
    it('Fail to delete account from other zone', function(done) {
      request({
        url: `${ROOT_URL}/account/delete`,
        method: 'POST',
        json: {
    ...
    it('Create user', function(done) {
      request({
        ...
        json: {
          ...
          role: faker.random.number({max: 255, min: 16}),
      ...
      models.users.bulkCreate([
        {
          ...
          role: faker.random.number({max: 511, min: 16}),
          recover_code: "",
          recover_expire: 0,
          status: 'active',
          zone_id: self_zone_id,
    ...
    it('Update user from same account', function(done) {
      request({
        ...
        json: {
          ...
          phoneNumber: "",
          role: faker.random.number({min: 16, max: 511})
        },
        headers: {
          authorization: token
        }
  ...
  describe('Delete user', function() {
    ...
    it('Fail to delete user from other zone', function(done) {
      request({
        url: `${ROOT_URL}/user/delete`,
        method: 'POST',
        json: {
