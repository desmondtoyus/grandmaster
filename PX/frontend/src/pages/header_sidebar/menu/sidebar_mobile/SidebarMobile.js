      ...
      <div className={sidebarClass}>
        ...
        <Scrollbar className='sidebar__scroll scroll'>
          <div className='sidebar__wrapper sidebar__wrapper--mobile'>
            <SidebarContent onClick={this.changeMobileSidebarVisibility} query={this.props.query} history={this.props.history} title={this.props.title} user={this.props.user} callback={this.props.callback}/>
          </div>
        </Scrollbar>
      </div>
    )
