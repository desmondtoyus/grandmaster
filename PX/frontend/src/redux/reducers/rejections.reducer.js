import {
  ...
  export default function(state = INITIAL_STATE, action) {
    switch(action.type) {
      case CHANGE_REJECTIONS_STATE:
        return { ...state, [action.prop]: action.value };
      case OLAP_REJECTIONS_VALIDATION:
