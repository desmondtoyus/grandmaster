module.exports = {
  ...
  browserify: {
    command: 'browserify js/src/main.js -o js/dist/vast-vpaid.js -t [ babelify ] -v'
  },
  watchify: {
    command: 'watchify js/src/main.js -o js/dist/vast-vpaid.js -t [ babelify ] -v'
  },
  uglify: {
    command: 'uglifyjs js/dist/vast-vpaid.js --compress --define DEBUG=false --mangle --screw-ie8 --comments -o js/dist/vast-vpaid.min.js'
  },
  jsbeautify: {
