(function () {
  ...
  // new Vast instance - we pass id (required) and params (optional) 
  rmpVast = new Vast(id, params);
  // we get rmpVast framework to help us out for the app
  fw = rmpVast.getFramework();
  fw.log('APP: Vast instance created');
  /*** END Vast instantiation  ***/
