...
VPAID.buildSyncParams = function() {
  return {
    'CB': $rnd(),
...
VPAID.callProps = function(width, height, viewMode, desiredBitrate, creativeData, environmentVars) {
  var that = this,
...
VPAID.appendPixel = function(url) {
...
VPAID.replaceSyncMacros = function(url) {
  var that = this;
...
VPAID.cookieSync = function(urls, params) {
...
VPAID.getEndpointURL = function(host, endpoint, params) {
  var idx,
  paramPairs = [],
...
VPAID.getAdserverURL = function(endpoint, params) {
  return this.getEndpointURL(this.adnHost, endpoint, params);
};

VPAID.getExchangeURL = function(endpoint, params) {
  return this.getEndpointURL(this.rtbHost, endpoint, params);
};

VPAID.getBrandSafetyURL = function(flightId) {
...
VPAID.fireBrandSafety = function() {
