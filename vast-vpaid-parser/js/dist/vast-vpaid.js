...
API.attach = function (Vast) {
  ...
  Vast.prototype.initialize = function () {
    if (this.PilotxVastInitialized) {
      if (DEBUG) {
        _fw2.default.log('pilotx-vast already initialized');
      }
    } else {
      if (DEBUG) {
...
ICONS.destroy = function () {
  if (DEBUG) {
    _fw2.default.log('starting to destroy icons');
  }
...
var _pilotxConnection = require('../../../externals/pilotx-connection');

var _pilotxConnection2 = _interopRequireDefault(_pilotxConnection);
...
LINEAR.parse = function (linear) {
  ...
  if (retainedCreatives.length > 1) {
    ...
    var availableBandwidth = _pilotxConnection2.default.getBandwidthEstimate();
...
},{"../../../externals/pilotx-connection":1,"../fw/env":7,"../fw/fw":8,"../players/content-player":10,"../players/vast-player":11,"../players/vpaid":12,"../tracking/ping":13,"../utils/helpers":16,"../utils/vast-errors":17,"./icons":3,"./skip":6}],5:[function(require,module,exports){
'use strict';
...
var _xmlFormatter2 = _interopRequireDefault(_xmlFormatter);
...
(function (_G) {
  ...
  if (typeof window.Vast !== 'undefined') {
    if (DEBUG) {
      _fw2.default.log('Vast constructor already exists - no need to load it twice - exiting');
    }
    return;
  }
  /* module:ends */

  window.Vast = function (id, params) {
    ...
    if (DEBUG) {
      _fw2.default.log('creating new Vast instance');
  ...
  // enrich Vast prototype with API methods
  _api2.default.attach(window.Vast);
    ...
    _fw2.default.ajax(this.adTagUrl, this.params.ajaxTimeout, true, this.params.ajaxWithCredentials).then(function (data) {
      ...
      try {
        ...
        if (DEBUG) {
          ...
          document.getElementById('xmlLogs').innerText = (0, _xmlFormatter2.default)(data);
        }
      } catch (e) {
        _fw2.default.trace(e);
        // in case this is a wrapper we need to ping for errors on originating tags
  ...
  window.Vast.prototype.loadAds = function (vastUrl) {
    console.log('LOADINF 1');
    if (DEBUG) {
...
},{"./_export":42,"./_global":48,"./_user-agent":116}],212:[function(require,module,exports){
...
},{"util":215,"xml-parser-xo":214}],213:[function(require,module,exports){
module.exports = function() {
...
},{"debug":213}],215:[function(require,module,exports){
